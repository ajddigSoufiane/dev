...
import { OrganismeEditComponent} from './pages/organisme-edit/organisme-edit.component';
import { OrganismeListComponent} from './pages/organisme-list/organisme-list.component';
...
const routes: Routes = [
    ...
    { path: 'organismes/:id',  loadChildren: './pages/organisme-edit/organisme-edit.module#OrganismeEditModule' , canActivate: [AuthGuard] },
    { path: 'organismes',  loadChildren: './pages/organisme-list/organisme-list.module#OrganismeListModule' , canActivate: [AuthGuard] },
